...
export const SupplierEntityTable = memo(() => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      enqueueSnackbar('Поставщик успешно удален', { variant: 'success' });
      navigate('/suppliers');
    } catch (err) {
      setError(err.message);
      enqueueSnackbar('Ошибка при удалении поставщика', { variant: 'error' });
    } finally {
      setLoading(false);
    }
  };
            ...
            <Table>
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>{supplier.patronymic || '-'}</TableCell>
                </TableRow>
                <TableRow>
          ...
          >
            ...
            >
              <Typography id="modal-title" variant="h6" component="h2">
                Подтвердить удаление поставщика
              </Typography>
